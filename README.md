...
```
cd existing_repo
git remote add origin https://gitlab.com/g4215/app-fast-food-bot.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/g4215/app-fast-food-bot/-/settings/integrations)
